...
public class AnchorOperationsBase<H extends AnchorHolderMain<?, ?, H, ?>> 
	...
	public H notEqualTo(final Object arg) {
		return this.create(Query.from(this.getName(), Operations.NE, arg));
	}

	public H greaterThan(final Object arg) {
		return this.create(Query.from(this.getName(), Operations.GT, arg));
	}

	public H greaterThanOrEqual(final Object arg) {
		return this.create(Query.from(this.getName(), Operations.GTE, arg));
	}

	public H lessThan(final Object arg) {
		return this.create(Query.from(this.getName(), Operations.LT, arg));
	}

	public H lessThanOrEqual(final Object arg) {
		return this.create(Query.from(this.getName(), Operations.LTE, arg));
	}
	...
	public H noNotInValues(final Collection<?> arg) {
		return this.create(Query.from(this.getName(), Operations.NIN, this.listFormatting(arg)));
	}

	public H like(final Object arg) {
		return this.create(Query.from(this.getName(), Operations.LIKE, arg));
	}

	public H likeCaseInSensitive(final Object arg) {
		return this.create(Query.from(this.getName(), Operations.ILIKE, arg));
	}

	public H notLike(final Object arg) {
		return this.create(Query.from(this.getName(), Operations.NOT_LIKE, arg));
	}

	public H regexp(final Object arg) {
		return this.create(Query.from(this.getName(), Operations.REGEXP, arg));
	}
