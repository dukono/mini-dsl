...
public class ApiGenerator {
	...
	public void generate(final DslContext context, final Filer filer) throws IOException {
		...
		final String anchorClass = "AnchorActions";
		...
		final TypeSpec.Builder classBuilder = TypeSpec.classBuilder(className)
				...
				.addJavadoc("Contains all nested DSL classes: Fields, Operations, Anchors, and factory methods.\n")
				.addJavadoc("\n").addJavadoc("Example:\n").addJavadoc("<pre>\n").addJavadoc("$L.from()\n", className)
		...
		classBuilder.addType(new OperationsGenerator().generateAsNestedClass(context));
		...
		final MethodSpec fromDtoMethod = MethodSpec.methodBuilder("from").addModifiers(Modifier.PUBLIC, Modifier.STATIC)
				.returns(anchorClassName).addParameter(ClassName.get(context.getPackageName(), className, "Dto"), "dto")
