...
public class AnchorOneGenerator {
	...
	public TypeSpec generateAsNestedClass(final DslContext context) {
		final String className = "AnchorOne";
		final String fieldsClassName = "Fields";
		final String operationsOneClassName = "AnchorOperationsOne";
		...
		final MethodSpec constructor = MethodSpec.constructorBuilder().addModifiers(Modifier.PUBLIC)
				.addStatement("super(new $T<$L>() {}, new $L(), new $T<$L<$L<T>, T>>() {})",
						ClassName.get("com.google.common.reflect", "TypeToken"), dtoClassName, fieldsClassName,
						ClassName.get("com.google.common.reflect", "TypeToken"), operationsOneClassName, className)
				.build();
