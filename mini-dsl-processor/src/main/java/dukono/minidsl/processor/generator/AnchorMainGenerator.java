...
public class AnchorMainGenerator {
	...
	public TypeSpec generateAsNestedClass(final DslContext context) {
		final String className = "AnchorMain";
		final String fieldsClass = "Fields";
		final String operationsClass = "AnchorOperations";
		final String dtoSimpleName = "Dto";
		...
		final TypeSpec.Builder classBuilder = TypeSpec.classBuilder(className)
				...
				.superclass(ParameterizedTypeName.get(baseClass, ClassName.bestGuess(fieldsClass),
						ClassName.bestGuess(dtoSimpleName), ClassName.bestGuess(className),
		...
		final MethodSpec constructor = MethodSpec.constructorBuilder().addModifiers(Modifier.PUBLIC)
				.addStatement(
						"super(\n" + "    new $T<$L>() {},\n" + "    new $T<AnchorList<?>>() {},\n"
								+ "    new $T<$L<$L>>() {},\n" + "    new $L()\n" + ")",
						ClassName.get("com.google.common.reflect", "TypeToken"), dtoSimpleName,
						ClassName.get("com.google.common.reflect", "TypeToken"),
						ClassName.get("com.google.common.reflect", "TypeToken"), operationsClass, className,
						fieldsClass)
				.build();
